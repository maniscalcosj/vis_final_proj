...
Promise.all([ // load multiple files
  ...
  d3.json('counties-albers-10m.json',d3.autoType)
    ...
    counties.features.forEach(c => {
      ...
      c.properties.county = fc === null ? null : fc.county
      c.properties.state = fc === null ? null : fc.state
      c.filtered = 0
    })
...
//     console.log("number of turbines", turbines)
    ...
    const windMapPlot = windMap(counties, states)
    const windScatterPlot = windScatter(fullData)
    //let choice = windMapPlot.getChoice();
